...
let currenttype;
let uniquemaplist;
const imageBaseURL = "https://raw.githubusercontent.com/KZGlobalTeam/map-images/public/thumbnails/";
  ...
  if (document.getElementById("searchMap").value.length > 0) {
    ...
    $.ajax({
      ...
      success: function(mapTP) {
        ...
        if (mapTP.length === 0) {
          ...
          document.getElementById("MapData-Image").src = imageBaseURL + searchMapName + ".jpg";
          document.getElementById("loading").style.zIndex = -1;
          document.getElementById("loading").style.opacity = 0;
          return;
        }
        ...
        document.getElementById("MapData-Image").src = imageBaseURL + mapTP[0].map_name + ".jpg";
    ...
    $.ajax({
      ...
      success: function(mapPro) {
        ...
        document.getElementById("MapData-Image").src = imageBaseURL + mapPro[0].map_name + ".jpg";
